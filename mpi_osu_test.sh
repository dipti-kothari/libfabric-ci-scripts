...
curl_cmd="curl ${CURL_OPT} -O http://mvapich.cse.ohio-state.edu/download/mvapich/osu-micro-benchmarks-5.6.2.tar.gz"
curl_check "$curl_cmd" "osu-micro-benchmarks-5.6.2.tar.gz"
